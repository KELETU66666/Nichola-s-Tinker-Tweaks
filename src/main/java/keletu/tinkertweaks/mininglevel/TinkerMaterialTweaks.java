...
public final class TinkerMaterialTweaks {
    ...
    public static void modifyToolMaterials() {
        ...
        for (Material material : copyOfMaterials) {
            ...
            HandleMaterialStats statsHandle = material.getStatsOrUnknown(MaterialTypes.HANDLE);

            if (stats != null && statsHandle != null && TinkerTools.pickHead.canUseMaterial(material)) {
                // new harvest level
