...
public class CommonProxy {
    ...
    private static SoundEvent SOUND_CHICKEN = sound("chicken");

    public void playLevelupChicken(EntityPlayer player) {
        Sounds.PlaySoundForPlayer(player, SOUND_CHICKEN, 1f, 1f);
    }
