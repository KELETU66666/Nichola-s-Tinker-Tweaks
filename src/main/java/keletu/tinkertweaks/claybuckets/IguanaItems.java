package keletu.tinkertweaks.claybuckets;

import keletu.tinkertweaks.KeletuTinkerTweaks;
import keletu.tinkertweaks.claybuckets.proxy.ItemsCommonProxy;
...
public class IguanaItems {
    ...
    @SidedProxy(clientSide = "keletu.tinkertweaks.claybuckets.proxy.ItemsClientProxy", serverSide = "keletu.tinkertweaks.claybuckets.proxy.ItemsCommonProxy")
    ...
    public static void preInit(FMLPreInitializationEvent event)
    {
        ...
        // add recipes
        ForgeRegistries.RECIPES.register(new ShapedOreRecipe(new ResourceLocation(KeletuTinkerTweaks.MODID, "claybucketunfired"), new ItemStack(clayBucketUnfired), "c c", " c ", 'c', new ItemStack(Items.CLAY_BALL)).setRegistryName(KeletuTinkerTweaks.MODID, "claybucketunfired"));
