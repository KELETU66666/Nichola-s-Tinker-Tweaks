...
public class ItemClayBucket extends Item {
	...
	public String getItemStackDisplayName(ItemStack stack) {
		if(hasSpecialFluid(stack)) {
			...
			return I18n.translateToLocal("item." + Reference.prefix("clay_bucket." + specialFluid) + ".name");
		}
		FluidStack fluidStack = getFluid(stack);
		if(fluidStack == null) {
			return I18n.translateToLocal("item." + Reference.prefix("clay_bucket.empty") + ".name");
		}
