...
public final class Tooltips {
    ...
    public static void addTooltips(ItemStack itemStack, List<String> tooltips) {
        ...
        NBTTagCompound tag1 = TinkerUtil.getModifierTag(itemStack, LiketechniksTinkerTweaks.modHarvestLeveling.getModifierIdentifier());
        if (!tag1.isEmpty()) {
            ...
            if (data.isBoosted)
                ...
                tooltips.add(2, getBoostXpToolTip(data.bxp, LiketechniksTinkerTweaks.modHarvestLeveling.getXpForLevelup(data.level, itemStack)));
    ...
    public static String getBoostXpToolTip(int xp, int xpNeeded) {
        return getXpToolTip(xp, xpNeeded);
    }
